    ...
    8769: (t, e, r) => {
      ...
      var s,
        ...
        tF = function (t, e, r, i) {
          return (
            e.parent && tD(e),
            (e._start = t_(
              (A(r) ? r : r || t !== u ? tG(t, r, e) : t._time) + e._delay
            )),
            (e._end = t_(
        ...
        tV = function (t) {
          return t instanceof eC ? tA(t) : tQ(t, t._dur);
        },
        ...
        es = function (t, e, r) {
          var i,
            ...
            f,
            l,
            c = t ? (A(t) ? [t >> 16, (t >> 8) & 255, 255 & t] : 0) : ei.black;
          if (!c) {
            if (
      ...
      var eC = (function (t) {
        ...
        return (
          ...
          (r.add = function (t, e) {
            var r = this;
            if ((A(e) || (e = tG(this, e, t)), !(t instanceof eM))) {
              if (z(t))
                return (
                  t.forEach(function (t) {
                    return r.add(t, e);
          ...
          (r.getTweensOf = function (t, e) {
            for (var r, i = [], n = tZ(t), s = this._first, a = A(e); s; )
              s instanceof eQ
                ? tl(s._targets, n) &&
                  (a
                    ? (!eR || (s._initted && s._ts)) &&
      ...
      var eQ = (function (t) {
        function e(e, r, n, a) {
          ...
          var o,
            ...
            E = g.yoyoEase,
            P = r.parent || u,
            F = (z(e) || O(e) ? A(e[0]) : "length" in r) ? [e] : tZ(e);
          if (
            ((o._targets = F.length
              ? ts(F)
              : G(
      ...
      var eV = function (t, e, r) {
        ...
        eY = function (t, e) {
          return D(t[e]) ? ej : M(t[e]) && t.setAttribute ? eW : eV;
        },
        eH = function (t, e) {
